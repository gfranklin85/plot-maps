...
function LoginForm() {
  ...
  // Show error from failed OAuth redirect
            ...
            <button
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  setError((error as Error)?.message || 'Unable to start Google sign in.');
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <button
                    ...
                    className="text-xs font-bold text-indigo-400 hover:text-indigo-300 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500/40 rounded"
                  >
                    Forgot password?
                  </button>
                </div>
