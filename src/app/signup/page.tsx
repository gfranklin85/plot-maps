...
export default function SignupPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0c1324] relative overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md text-center px-6">
          <div className="backdrop-blur-xl bg-[#151b2d]/40 border border-white/5 rounded-2xl p-8 shadow-2xl">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0c1324] relative overflow-hidden">
      {/* Ambient background */}
      <div className="absolute inset-0 opacity-40" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(79,70,229,0.05) 1px, transparent 0)', backgroundSize: '40px 40px' }} />
      <div className="absolute -top-40 -right-40 w-96 h-96 bg-indigo-600 rounded-full blur-[160px] opacity-10" />
      <div className="absolute -bottom-40 -left-40 w-[500px] h-[500px] bg-orange-600 rounded-full blur-[200px] opacity-10" />
      ...
      <main className="relative z-10 w-full max-w-[480px] px-6">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-400 font-medium mt-2">Create your free account — 50 geocodes included</p>
        </div>
        ...
        <div className="backdrop-blur-xl bg-[#151b2d]/40 border border-white/5 rounded-2xl p-8 md:p-10 shadow-2xl">
          <div className="space-y-6">
            <div>
              <h2 className="font-headline text-xl font-bold text-slate-100">Get started</h2>
              <p className="text-slate-400 text-sm mt-1">Start prospecting properties in minutes</p>
            </div>
            ...
            <div className="relative flex items-center py-2">
              ...
              <span className="flex-shrink mx-4 text-[10px] uppercase tracking-widest text-slate-500 font-bold">Or sign up with email</span>
              <div className="flex-grow border-t border-white/5" />
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link href="/login" className="text-indigo-400 font-bold hover:underline underline-offset-4 ml-1">
                Sign in
              </Link>
            </p>
          </div>
